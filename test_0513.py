...
if "messages" not in st.session_state:
    ...
    st.session_state.messages.append({
        ...
        모둠의 주제를 선정하는데에 도움을 줄 때에는 적절한 양의 스토리 보드 제작을 위해 너무 넓은 주제를 선택하지 않게 해주세요.
        예를 들어서 단순하게 주제를 데이터 센터라고만 정하지 말고, 데이터 센터의 건설 위치를 주제로 권유해주세요.
        그리고 단순하게 주제를 맹그로브 숲이라고만 정하지 말고, 맹그로브 숲의 영향과 같은 주제로 권유해주세요. 
        독서 후 모둠에서 스토리보드의 전체 주제를 정한 후 각 학생들은 그 중 몇 장을 제작하는 역할을 부여 받았습니다.
